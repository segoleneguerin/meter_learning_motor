...
function meterlearning_motor_paper_figures_eeg_zscores(analysis_type, normalization, disp_stim_zscore)
    ...
    for i_cond = [2,3]
        for i_ses = [1,3]
            ...
            scatter(xPos_jittered(:,i_ses),z_scores(:,i_ses), ...
                    ...
                    'MarkerEdgeColor',colors{i_cond}, 'MarkerFaceAlpha', 0.5, ...
...
%         line([x(1)-0.3 x(1)-0.3],[lowest_3_beat highest_3_beat],'Color', colors{2} ,'LineWidth',grid_linewidth+0.2)
    ...
    fig_name = sprintf('Fig2c - grp%i - norm%1- stim%i.svg', i_grp, normalization, disp_stim_zscore);
